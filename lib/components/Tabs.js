  ...
  _createClass(Tabs, [{
    ...
    value: function getCloseButton(tab, style, classes, hoverStyleBase) {
      ...
      return _react2.default.createElement(
        _CloseIcon2.default,
        { style: style, hoverStyle: onHoverStyle, className: classes, onClick: this.handleCloseButtonClick.bind(this, tab.key) },
        '\xD7'
      );
    }
  }, {
      ...
      var tabs = this.state.tabs.map(function (tab) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              _extends({ style: tabTiteleStyle, className: tabTitleClasses }, extraAttribute),
              title
            ),
            _react2.default.createElement(
              'span',
